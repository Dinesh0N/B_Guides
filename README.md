...
*   **Appearance**: Fine-tune line colors, opacity, and thickness to ensure visibility against any footage or render.
*   **Separate Settings**: Keep your VSE workspace distinct from your 3D camera setups.

## Usage
1.  **VSE**: Open the side panel (N) in the Sequencer Preview to access "VSE Guides".
2.  **3D Viewport**: Select a Camera and look for the "VSE Guides" panel to configure settings specific to that camera.
3.  **Presets**: Use the header buttons to save your current configuration as a preset for future use.

## Compatibility
*   **Blender Version**: 4.2 LTS and above (Compatible with Blender 5.0).
